...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    .line 268
    iput-boolean v2, p0, Landroid/support/design/chip/ChipDrawable;->textWidthDirty:Z
    ...
    .line 330
    iput-object v3, p0, Landroid/support/design/chip/ChipDrawable;->debugPaint:Landroid/graphics/Paint;
    ...
    .line 337
    iput-boolean v2, p0, Landroid/support/design/chip/ChipDrawable;->shouldDrawText:Z
...
.method private calculateChipIconBounds(Landroid/graphics/Rect;Landroid/graphics/RectF;)V
    ...
    iget v2, p0, Landroid/support/design/chip/ChipDrawable;->iconStartPadding:F
...
.method private calculateChipTouchBounds(Landroid/graphics/Rect;Landroid/graphics/RectF;)V
    ...
    iget v2, p0, Landroid/support/design/chip/ChipDrawable;->closeIconEndPadding:F
    ...
    iget v2, p0, Landroid/support/design/chip/ChipDrawable;->closeIconStartPadding:F
...
.method private calculateTextBounds(Landroid/graphics/Rect;Landroid/graphics/RectF;)V
    ...
    .line 815
    iget-object v2, p0, Landroid/support/design/chip/ChipDrawable;->unicodeWrappedText:Ljava/lang/CharSequence;

    if-eqz v2, :cond_39

    .line 816
    iget v2, p0, Landroid/support/design/chip/ChipDrawable;->chipStartPadding:F
    ...
    iget v3, p0, Landroid/support/design/chip/ChipDrawable;->textStartPadding:F

    add-float v1, v2, v3

    .line 817
    .local v1, "offsetFromStart":F
    iget v2, p0, Landroid/support/design/chip/ChipDrawable;->chipEndPadding:F
    ...
    iget v3, p0, Landroid/support/design/chip/ChipDrawable;->textEndPadding:F
...
.method public static createFromResource(Landroid/content/Context;I)Landroid/support/design/chip/ChipDrawable;
    ...
    throw v6
    :try_end_1c
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_1 .. :try_end_1c} :catch_1c
    .catch Ljava/io/IOException; {:try_start_1 .. :try_end_1c} :catch_51
    ...
    .line 316
    :cond_5f
    sget v6, Landroid/support/design/R$attr;->chipStandaloneStyle:I

    invoke-static {p0, v0, v6, v4}, Landroid/support/design/chip/ChipDrawable;->createFromAttributes(Landroid/content/Context;Landroid/util/AttributeSet;II)Landroid/support/design/chip/ChipDrawable;
    :try_end_64
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_3d .. :try_end_64} :catch_1c
    .catch Ljava/io/IOException; {:try_start_3d .. :try_end_64} :catch_51
...
.method private drawCheckedIcon(Landroid/graphics/Canvas;Landroid/graphics/Rect;)V
    ...
    invoke-direct {p0, p2, v2}, Landroid/support/design/chip/ChipDrawable;->calculateChipIconBounds(Landroid/graphics/Rect;Landroid/graphics/RectF;)V
...
.method private drawChipStroke(Landroid/graphics/Canvas;Landroid/graphics/Rect;)V
    ...
    iget v2, p0, Landroid/support/design/chip/ChipDrawable;->currentChipStrokeColor:I
    ...
    iget v3, p0, Landroid/support/design/chip/ChipDrawable;->chipStrokeWidth:F
...
.method private drawCloseIcon(Landroid/graphics/Canvas;Landroid/graphics/Rect;)V
    ...
    invoke-direct {p0, p2, v2}, Landroid/support/design/chip/ChipDrawable;->calculateCloseIconBounds(Landroid/graphics/Rect;Landroid/graphics/RectF;)V
...
.method private drawDebug(Landroid/graphics/Canvas;Landroid/graphics/Rect;)V
    ...
    invoke-static {v1, v6}, Landroid/support/v4/graphics/ColorUtils;->setAlphaComponent(II)I
    ...
    iget-object v5, p0, Landroid/support/design/chip/ChipDrawable;->debugPaint:Landroid/graphics/Paint;
...
.method private drawText(Landroid/graphics/Canvas;Landroid/graphics/Rect;)V
    ...
    invoke-direct {p0, p2, v0}, Landroid/support/design/chip/ChipDrawable;->calculateTextBounds(Landroid/graphics/Rect;Landroid/graphics/RectF;)V
    ...
    iget-object v4, p0, Landroid/support/design/chip/ChipDrawable;->textPaint:Landroid/text/TextPaint;

    iget-object v5, p0, Landroid/support/design/chip/ChipDrawable;->fontCallback:Landroid/support/v4/content/res/ResourcesCompat$FontCallback;

    invoke-virtual {v0, v3, v4, v5}, Landroid/support/design/resources/TextAppearance;->updateDrawState(Landroid/content/Context;Landroid/text/TextPaint;Landroid/support/v4/content/res/ResourcesCompat$FontCallback;)V
    ...
    iget-object v5, p0, Landroid/support/design/chip/ChipDrawable;->truncateAt:Landroid/text/TextUtils$TruncateAt;
    ...
    iget-object v6, p0, Landroid/support/design/chip/ChipDrawable;->textPaint:Landroid/text/TextPaint;
...
.method private loadFromAttributes(Landroid/util/AttributeSet;II)V
    ...
    sget v1, Landroid/support/design/R$styleable;->Chip_chipBackgroundColor:I
    ...
    .line 348
    sget v0, Landroid/support/design/R$styleable;->Chip_chipMinHeight:I
    ...
    .line 349
    sget v0, Landroid/support/design/R$styleable;->Chip_chipCornerRadius:I
    ...
    .line 352
    sget v0, Landroid/support/design/R$styleable;->Chip_chipStrokeWidth:I
    ...
    .line 355
    sget v0, Landroid/support/design/R$styleable;->Chip_android_text:I
    ...
    .line 357
    invoke-static {v0, v6, v1}, Landroid/support/design/resources/MaterialResources;->getTextAppearance(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/support/design/resources/TextAppearance;
    ...
    .line 359
    sget v0, Landroid/support/design/R$styleable;->Chip_android_ellipsize:I
    ...
    .line 377
    :goto_68
    sget v0, Landroid/support/design/R$styleable;->Chip_chipIconVisible:I
    ...
    .line 382
    sget v0, Landroid/support/design/R$styleable;->Chip_chipIconEnabled:I
    ...
    .line 386
    sget v0, Landroid/support/design/R$styleable;->Chip_chipIconSize:I
    ...
    .line 388
    sget v0, Landroid/support/design/R$styleable;->Chip_closeIconVisible:I
    ...
    .line 394
    sget v0, Landroid/support/design/R$styleable;->Chip_closeIconEnabled:I
    ...
    .line 399
    sget v0, Landroid/support/design/R$styleable;->Chip_closeIconSize:I
    ...
    .line 401
    sget v0, Landroid/support/design/R$styleable;->Chip_android_checkable:I
    ...
    .line 402
    sget v0, Landroid/support/design/R$styleable;->Chip_checkedIconVisible:I
    ...
    .line 408
    sget v0, Landroid/support/design/R$styleable;->Chip_checkedIconEnabled:I
    ...
    sget v1, Landroid/support/design/R$styleable;->Chip_checkedIcon:I
    ...
    sget v1, Landroid/support/design/R$styleable;->Chip_showMotionSpec:I

    invoke-static {v0, v6, v1}, Landroid/support/design/animation/MotionSpec;->createFromAttribute(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/support/design/animation/MotionSpec;
    ...
    sget v1, Landroid/support/design/R$styleable;->Chip_hideMotionSpec:I
    ...
    .line 415
    sget v0, Landroid/support/design/R$styleable;->Chip_chipStartPadding:I
    ...
    .line 416
    sget v0, Landroid/support/design/R$styleable;->Chip_iconStartPadding:I
    ...
    .line 417
    sget v0, Landroid/support/design/R$styleable;->Chip_iconEndPadding:I
    ...
    .line 418
    sget v0, Landroid/support/design/R$styleable;->Chip_textStartPadding:I
    ...
    .line 419
    sget v0, Landroid/support/design/R$styleable;->Chip_textEndPadding:I
    ...
    .line 420
    sget v0, Landroid/support/design/R$styleable;->Chip_closeIconStartPadding:I
    ...
    .line 421
    sget v0, Landroid/support/design/R$styleable;->Chip_closeIconEndPadding:I
    ...
    .line 422
    sget v0, Landroid/support/design/R$styleable;->Chip_chipEndPadding:I
    ...
    .line 424
    sget v0, Landroid/support/design/R$styleable;->Chip_android_maxWidth:I
    ...
    invoke-virtual {p0, v0}, Landroid/support/design/chip/ChipDrawable;->setMaxWidth(I)V
    ...
    invoke-virtual {p0, v0}, Landroid/support/design/chip/ChipDrawable;->setEllipsize(Landroid/text/TextUtils$TruncateAt;)V
...
.method private onStateChange([I[I)Z
    ...
    iget-object v11, p0, Landroid/support/design/chip/ChipDrawable;->chipBackgroundColor:Landroid/content/res/ColorStateList;

    if-eqz v11, :cond_dd

    iget-object v11, p0, Landroid/support/design/chip/ChipDrawable;->chipBackgroundColor:Landroid/content/res/ColorStateList;

    iget v12, p0, Landroid/support/design/chip/ChipDrawable;->currentChipBackgroundColor:I
    ...
    :goto_12
    iget v11, p0, Landroid/support/design/chip/ChipDrawable;->currentChipBackgroundColor:I
    ...
    .line 970
    :cond_19
    iget-object v11, p0, Landroid/support/design/chip/ChipDrawable;->chipStrokeColor:Landroid/content/res/ColorStateList;

    if-eqz v11, :cond_e0

    iget-object v11, p0, Landroid/support/design/chip/ChipDrawable;->chipStrokeColor:Landroid/content/res/ColorStateList;

    iget v12, p0, Landroid/support/design/chip/ChipDrawable;->currentChipStrokeColor:I
    ...
    :goto_25
    iget v11, p0, Landroid/support/design/chip/ChipDrawable;->currentChipStrokeColor:I
    ...
    .line 979
    :cond_2c
    iget-object v11, p0, Landroid/support/design/chip/ChipDrawable;->compatRippleColor:Landroid/content/res/ColorStateList;

    if-eqz v11, :cond_e3

    iget-object v11, p0, Landroid/support/design/chip/ChipDrawable;->compatRippleColor:Landroid/content/res/ColorStateList;

    iget v12, p0, Landroid/support/design/chip/ChipDrawable;->currentCompatRippleColor:I
    ...
    :goto_38
    iget v11, p0, Landroid/support/design/chip/ChipDrawable;->currentCompatRippleColor:I
    ...
    .line 985
    iget-boolean v11, p0, Landroid/support/design/chip/ChipDrawable;->useCompatRipple:Z
    ...
    .line 990
    :cond_43
    iget-object v11, p0, Landroid/support/design/chip/ChipDrawable;->textAppearance:Landroid/support/design/resources/TextAppearance;

    if-eqz v11, :cond_e6

    iget-object v11, p0, Landroid/support/design/chip/ChipDrawable;->textAppearance:Landroid/support/design/resources/TextAppearance;

    iget-object v11, v11, Landroid/support/design/resources/TextAppearance;->textColor:Landroid/content/res/ColorStateList;
    ...
    iget v12, p0, Landroid/support/design/chip/ChipDrawable;->currentTextColor:I
    ...
    :goto_57
    iget v11, p0, Landroid/support/design/chip/ChipDrawable;->currentTextColor:I
    ...
    invoke-static {v11, v12}, Landroid/support/design/chip/ChipDrawable;->hasState([II)Z

    move-result v11

    if-eqz v11, :cond_e9

    iget-boolean v11, p0, Landroid/support/design/chip/ChipDrawable;->checkable:Z
    ...
    :goto_70
    iget-boolean v11, p0, Landroid/support/design/chip/ChipDrawable;->currentChecked:Z

    if-eq v11, v1, :cond_88

    iget-object v11, p0, Landroid/support/design/chip/ChipDrawable;->checkedIcon:Landroid/graphics/drawable/Drawable;
    ...
    :cond_88
    iget-object v11, p0, Landroid/support/design/chip/ChipDrawable;->tint:Landroid/content/res/ColorStateList;

    if-eqz v11, :cond_eb

    iget-object v10, p0, Landroid/support/design/chip/ChipDrawable;->tint:Landroid/content/res/ColorStateList;

    iget v11, p0, Landroid/support/design/chip/ChipDrawable;->currentTint:I
    ...
    .local v7, "newTint":I
    :goto_94
    iget v10, p0, Landroid/support/design/chip/ChipDrawable;->currentTint:I

    if-eq v10, v7, :cond_a5

    .line 1013
    iput v7, p0, Landroid/support/design/chip/ChipDrawable;->currentTint:I

    .line 1014
    iget-object v10, p0, Landroid/support/design/chip/ChipDrawable;->tint:Landroid/content/res/ColorStateList;

    iget-object v11, p0, Landroid/support/design/chip/ChipDrawable;->tintMode:Landroid/graphics/PorterDuff$Mode;

    invoke-static {p0, v10, v11}, Landroid/support/design/drawable/DrawableUtils;->updateTintFilter(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;

    move-result-object v10

    iput-object v10, p0, Landroid/support/design/chip/ChipDrawable;->tintFilter:Landroid/graphics/PorterDuffColorFilter;
    ...
    .line 1018
    :cond_a5
    iget-object v10, p0, Landroid/support/design/chip/ChipDrawable;->chipIcon:Landroid/graphics/drawable/Drawable;

    invoke-static {v10}, Landroid/support/design/chip/ChipDrawable;->isStateful(Landroid/graphics/drawable/Drawable;)Z
    ...
    .line 1021
    :cond_b4
    iget-object v10, p0, Landroid/support/design/chip/ChipDrawable;->checkedIcon:Landroid/graphics/drawable/Drawable;
    ...
    .line 1024
    :cond_c3
    iget-object v10, p0, Landroid/support/design/chip/ChipDrawable;->closeIcon:Landroid/graphics/drawable/Drawable;
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    iget v5, p0, Landroid/support/design/chip/ChipDrawable;->alpha:I

    move-object v0, p1

    .line 561
    invoke-static/range {v0 .. v5}, Landroid/support/design/canvas/CanvasCompat;->saveLayerAlpha(Landroid/graphics/Canvas;FFFFI)I

    move-result v7

    .line 566
    :cond_2b
    invoke-direct {p0, p1, v6}, Landroid/support/design/chip/ChipDrawable;->drawChipBackground(Landroid/graphics/Canvas;Landroid/graphics/Rect;)V

    .line 569
    invoke-direct {p0, p1, v6}, Landroid/support/design/chip/ChipDrawable;->drawChipStroke(Landroid/graphics/Canvas;Landroid/graphics/Rect;)V

    .line 572
    invoke-direct {p0, p1, v6}, Landroid/support/design/chip/ChipDrawable;->drawCompatRipple(Landroid/graphics/Canvas;Landroid/graphics/Rect;)V

    .line 575
    invoke-direct {p0, p1, v6}, Landroid/support/design/chip/ChipDrawable;->drawChipIcon(Landroid/graphics/Canvas;Landroid/graphics/Rect;)V

    .line 578
    invoke-direct {p0, p1, v6}, Landroid/support/design/chip/ChipDrawable;->drawCheckedIcon(Landroid/graphics/Canvas;Landroid/graphics/Rect;)V
    ...
    .line 582
    invoke-direct {p0, p1, v6}, Landroid/support/design/chip/ChipDrawable;->drawText(Landroid/graphics/Canvas;Landroid/graphics/Rect;)V

    .line 586
    :cond_41
    invoke-direct {p0, p1, v6}, Landroid/support/design/chip/ChipDrawable;->drawCloseIcon(Landroid/graphics/Canvas;Landroid/graphics/Rect;)V

    .line 589
    invoke-direct {p0, p1, v6}, Landroid/support/design/chip/ChipDrawable;->drawDebug(Landroid/graphics/Canvas;Landroid/graphics/Rect;)V
...
.method public getOutline(Landroid/graphics/Outline;)V
    ...
    iget v5, p0, Landroid/support/design/chip/ChipDrawable;->chipCornerRadius:F
...
.method protected onSizeChange()V
    ...
    .prologue
    .line 450
    iget-object v1, p0, Landroid/support/design/chip/ChipDrawable;->delegate:Ljava/lang/ref/WeakReference;
...
.method public setCheckable(Z)V
    ...
    .prologue
    .line 1683
    iget-boolean v2, p0, Landroid/support/design/chip/ChipDrawable;->checkable:Z
    ...
    iget-boolean v2, p0, Landroid/support/design/chip/ChipDrawable;->currentChecked:Z
    ...
    iput-boolean v2, p0, Landroid/support/design/chip/ChipDrawable;->currentChecked:Z
...
.method public setCheckedIconVisible(Z)V
    ...
    .prologue
    .line 1714
    iget-boolean v3, p0, Landroid/support/design/chip/ChipDrawable;->checkedIconVisible:Z
...
.method public setChipIcon(Landroid/graphics/drawable/Drawable;)V
    ...
    :goto_14
    iput-object v3, p0, Landroid/support/design/chip/ChipDrawable;->chipIcon:Landroid/graphics/drawable/Drawable;
...
.method public setChipIconVisible(Z)V
    ...
    .prologue
    .line 1433
    iget-boolean v3, p0, Landroid/support/design/chip/ChipDrawable;->chipIconVisible:Z
...
.method public setCloseIcon(Landroid/graphics/drawable/Drawable;)V
    ...
    :goto_14
    iput-object v3, p0, Landroid/support/design/chip/ChipDrawable;->closeIcon:Landroid/graphics/drawable/Drawable;
...
.method public setCloseIconVisible(Z)V
    ...
    .prologue
    .line 1562
    iget-boolean v3, p0, Landroid/support/design/chip/ChipDrawable;->closeIconVisible:Z
...
.method public setIconEndPadding(F)V
    ...
    .prologue
    .line 1843
    iget v2, p0, Landroid/support/design/chip/ChipDrawable;->iconEndPadding:F
