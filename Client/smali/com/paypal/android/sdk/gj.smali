...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/paypal/android/sdk/gj;->c:Landroid/view/ViewGroup;

    iget-object v0, p0, Lcom/paypal/android/sdk/gj;->c:Landroid/view/ViewGroup;
    ...
    iput-object v0, p0, Lcom/paypal/android/sdk/gj;->e:Landroid/widget/RelativeLayout;

    iget-object v0, p0, Lcom/paypal/android/sdk/gj;->e:Landroid/widget/RelativeLayout;
    ...
    iget-object v1, p0, Lcom/paypal/android/sdk/gj;->e:Landroid/widget/RelativeLayout;
    ...
    iput-object v0, p0, Lcom/paypal/android/sdk/gj;->g:Landroid/widget/LinearLayout;

    iget-object v0, p0, Lcom/paypal/android/sdk/gj;->g:Landroid/widget/LinearLayout;
    ...
    iget-object v1, p0, Lcom/paypal/android/sdk/gj;->g:Landroid/widget/LinearLayout;
    ...
    invoke-static {v0, v5, v5, v1, v5}, Lcom/paypal/android/sdk/cv;->a(Landroid/view/View;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-object v0, p0, Lcom/paypal/android/sdk/gj;->f:Landroid/widget/ImageView;

    iget-object v0, p0, Lcom/paypal/android/sdk/gj;->f:Landroid/widget/ImageView;
    ...
    iget-object v1, p0, Lcom/paypal/android/sdk/gj;->f:Landroid/widget/ImageView;
    ...
    invoke-static {v0, v5, v5, v5, v1}, Lcom/paypal/android/sdk/cv;->b(Landroid/view/View;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    new-instance v0, Landroid/widget/ProgressBar;

    invoke-direct {v0, p1}, Landroid/widget/ProgressBar;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lcom/paypal/android/sdk/gj;->d:Landroid/widget/ProgressBar;

    iget-object v0, p0, Lcom/paypal/android/sdk/gj;->g:Landroid/widget/LinearLayout;

    iget-object v1, p0, Lcom/paypal/android/sdk/gj;->d:Landroid/widget/ProgressBar;

    invoke-virtual {v0, v1}, Landroid/widget/LinearLayout;->addView(Landroid/view/View;)V

    iget-object v0, p0, Lcom/paypal/android/sdk/gj;->d:Landroid/widget/ProgressBar;
    ...
    invoke-static {v0, v9, v7}, Lcom/paypal/android/sdk/cv;->a(Landroid/view/View;IF)V

    new-instance v0, Landroid/widget/TextView;

    invoke-direct {v0, p1}, Landroid/widget/TextView;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lcom/paypal/android/sdk/gj;->b:Landroid/widget/TextView;

    iget-object v0, p0, Lcom/paypal/android/sdk/gj;->b:Landroid/widget/TextView;

    sget-object v1, Lcom/paypal/android/sdk/cu;->t:Landroid/content/res/ColorStateList;

    invoke-virtual {v0, v1}, Landroid/widget/TextView;->setTextColor(Landroid/content/res/ColorStateList;)V

    iget-object v0, p0, Lcom/paypal/android/sdk/gj;->b:Landroid/widget/TextView;

    sget v1, Lcom/paypal/android/sdk/cu;->h:I
    ...
    iget-object v1, p0, Lcom/paypal/android/sdk/gj;->b:Landroid/widget/TextView;
    ...
    iput-object v0, p0, Lcom/paypal/android/sdk/gj;->a:Landroid/view/ViewGroup;
