...
.method constructor <init>(Landroid/content/Context;Lcom/paypal/android/sdk/payments/ag;)V
    ...
    iput-object v0, p0, Lcom/paypal/android/sdk/payments/ah;->d:Landroid/widget/ScrollView;

    iget-object v0, p0, Lcom/paypal/android/sdk/payments/ah;->d:Landroid/widget/ScrollView;
    ...
    iput-object v0, p0, Lcom/paypal/android/sdk/payments/ah;->e:Landroid/widget/LinearLayout;

    iget-object v0, p0, Lcom/paypal/android/sdk/payments/ah;->e:Landroid/widget/LinearLayout;
    ...
    iget-object v1, p0, Lcom/paypal/android/sdk/payments/ah;->e:Landroid/widget/LinearLayout;
    ...
    invoke-static {v2, v0, v1, v3, v4}, Lcom/paypal/android/sdk/cv;->a(Landroid/view/View;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v2, v0, v1}, Lcom/paypal/android/sdk/cv;->a(Landroid/view/View;II)V

    new-instance v0, Landroid/widget/ImageView;

    invoke-direct {v0, p1}, Landroid/widget/ImageView;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lcom/paypal/android/sdk/payments/ah;->f:Landroid/widget/ImageView;

    iget-object v0, p0, Lcom/paypal/android/sdk/payments/ah;->f:Landroid/widget/ImageView;
    ...
    invoke-static {v0, v1, v3}, Lcom/paypal/android/sdk/cv;->a(Landroid/view/View;ILjava/lang/String;)V
    ...
    invoke-static {v0, v1, v3, v4, v5}, Lcom/paypal/android/sdk/cv;->b(Landroid/view/View;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    new-instance v0, Landroid/widget/TextView;

    invoke-direct {v0, p1}, Landroid/widget/TextView;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lcom/paypal/android/sdk/payments/ah;->b:Landroid/widget/TextView;

    new-instance v3, Landroid/webkit/WebView;

    invoke-direct {v3, p1}, Landroid/webkit/WebView;-><init>(Landroid/content/Context;)V

    sget v0, Lcom/paypal/android/sdk/cu;->d:I

    invoke-virtual {v3, v0}, Landroid/webkit/WebView;->setBackgroundColor(I)V

    sget-boolean v0, Lcom/paypal/android/sdk/fq;->a:Z
    ...
    invoke-virtual {p2}, Lcom/paypal/android/sdk/payments/ag;->ordinal()I
    ...
    invoke-static {v3, v0, v1}, Lcom/paypal/android/sdk/cv;->a(Landroid/view/View;II)V
    ...
    invoke-static {v3, v0, v1, v4, v5}, Lcom/paypal/android/sdk/cv;->b(Landroid/view/View;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    new-instance v0, Landroid/widget/Button;

    invoke-direct {v0, p1}, Landroid/widget/Button;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lcom/paypal/android/sdk/payments/ah;->c:Landroid/widget/Button;

    iget-object v0, p0, Lcom/paypal/android/sdk/payments/ah;->c:Landroid/widget/Button;
    ...
    invoke-static {v0, v1, p1}, Lcom/paypal/android/sdk/cv;->a(Landroid/view/View;ZLandroid/content/Context;)V
    ...
    invoke-static {v0, v1, v2, v3, v4}, Lcom/paypal/android/sdk/cv;->b(Landroid/view/View;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    iget-object v0, p0, Lcom/paypal/android/sdk/payments/ah;->d:Landroid/widget/ScrollView;

    iput-object v0, p0, Lcom/paypal/android/sdk/payments/ah;->a:Landroid/view/View;
    ...
    :pswitch_176
    sget-object v0, Lcom/paypal/android/sdk/fs;->ai:Lcom/paypal/android/sdk/fs;
    ...
    :pswitch_17e
    sget-object v0, Lcom/paypal/android/sdk/fs;->aH:Lcom/paypal/android/sdk/fs;
    ...
    sget-object v6, Lcom/paypal/android/sdk/fs;->aG:Lcom/paypal/android/sdk/fs;

    invoke-static {v6}, Lcom/paypal/android/sdk/fq;->a(Lcom/paypal/android/sdk/fs;)Ljava/lang/String;
    ...
    sget-object v6, Lcom/paypal/android/sdk/fs;->aJ:Lcom/paypal/android/sdk/fs;
