...
.method static a(Landroid/app/Activity;Lcom/paypal/android/sdk/fs;Lcom/paypal/android/sdk/fs;Landroid/content/DialogInterface$OnClickListener;)Landroid/app/AlertDialog;
    .registers 7
    ...
    invoke-static {p1}, Lcom/paypal/android/sdk/fq;->a(Lcom/paypal/android/sdk/fs;)Ljava/lang/String;
    ...
    invoke-static {p2}, Lcom/paypal/android/sdk/fq;->a(Lcom/paypal/android/sdk/fs;)Ljava/lang/String;
...
.method private static a(Landroid/content/Context;Lcom/paypal/android/sdk/fs;Ljava/lang/String;Landroid/content/DialogInterface$OnClickListener;)Landroid/app/AlertDialog;
    .registers 8
...
.method static a(Landroid/app/Activity;Lcom/paypal/android/sdk/fs;Landroid/os/Bundle;)Landroid/app/Dialog;
    .registers 5
    ...
    invoke-static {p0, p1, v0, v1}, Lcom/paypal/android/sdk/payments/d;->a(Landroid/content/Context;Lcom/paypal/android/sdk/fs;Ljava/lang/String;Landroid/content/DialogInterface$OnClickListener;)Landroid/app/AlertDialog;
...
.method static a(Landroid/app/Activity;Lcom/paypal/android/sdk/fs;Landroid/os/Bundle;I)Landroid/app/Dialog;
    .registers 6
...
.method static a(Landroid/app/Activity;Lcom/paypal/android/sdk/fs;Landroid/os/Bundle;Landroid/content/DialogInterface$OnClickListener;)Landroid/app/Dialog;
    .registers 5
    ...
    invoke-static {p0, p1, v0, p3}, Lcom/paypal/android/sdk/payments/d;->a(Landroid/content/Context;Lcom/paypal/android/sdk/fs;Ljava/lang/String;Landroid/content/DialogInterface$OnClickListener;)Landroid/app/AlertDialog;
...
.method static a(Landroid/content/Context;Lcom/paypal/android/sdk/fs;Lcom/paypal/android/sdk/fs;)Landroid/app/Dialog;
    .registers 5
...
.method public static a(Landroid/app/Activity;Ljava/lang/Enum;)Landroid/graphics/Bitmap;
    ...
    :try_end_29
    .catch Ljava/lang/Exception; {:try_start_f .. :try_end_29} :catch_32
    ...
    invoke-static {v0, p0}, Lcom/paypal/android/sdk/cv;->c(Ljava/lang/String;Landroid/content/Context;)Landroid/graphics/Bitmap;
...
.method public static a(Lcom/paypal/android/sdk/dp;)Ljava/lang/Enum;
    .registers 7
    ...
    invoke-virtual {p0}, Lcom/paypal/android/sdk/dp;->h()Lcom/paypal/android/sdk/dr;

    move-result-object v5

    invoke-virtual {v5}, Lcom/paypal/android/sdk/dr;->toString()Ljava/lang/String;
...
.method public static a(Lcom/paypal/android/sdk/cs;)Ljava/lang/Object;
    .registers 7

    instance-of v0, p0, Lcom/paypal/android/sdk/ez;

    if-eqz v0, :cond_20

    check-cast p0, Lcom/paypal/android/sdk/ez;

    new-instance v0, Lcom/paypal/android/sdk/payments/ProofOfPayment;

    invoke-virtual {p0}, Lcom/paypal/android/sdk/ez;->v()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {p0}, Lcom/paypal/android/sdk/ez;->t()Ljava/lang/String;

    move-result-object v2

    invoke-virtual {p0}, Lcom/paypal/android/sdk/ez;->w()Ljava/lang/String;

    move-result-object v3

    invoke-virtual {p0}, Lcom/paypal/android/sdk/ez;->x()Ljava/lang/String;

    move-result-object v4

    invoke-virtual {p0}, Lcom/paypal/android/sdk/ez;->y()Ljava/lang/String;
    ...
    invoke-virtual {p0}, Lcom/paypal/android/sdk/fd;->C()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {p0}, Lcom/paypal/android/sdk/fd;->D()Ljava/lang/String;

    move-result-object v2

    invoke-virtual {p0}, Lcom/paypal/android/sdk/fd;->F()Ljava/lang/String;

    move-result-object v3

    invoke-virtual {p0}, Lcom/paypal/android/sdk/fd;->E()Ljava/lang/String;

    move-result-object v4

    invoke-virtual {p0}, Lcom/paypal/android/sdk/fd;->G()Ljava/lang/String;
...
.method static a(Landroid/app/Activity;Landroid/widget/TextView;Lcom/paypal/android/sdk/fs;)V
    .registers 7
    ...
    invoke-static {v1, p0, v2}, Lcom/paypal/android/sdk/cv;->a(Ljava/lang/String;Landroid/content/Context;I)Landroid/graphics/Bitmap;
    ...
    invoke-static {p0, p1, v0, v1, v2}, Lcom/paypal/android/sdk/d;->a(Landroid/app/Activity;Landroid/widget/TextView;Ljava/lang/String;Ljava/lang/String;Landroid/graphics/drawable/Drawable;)V
...
.method static a(Landroid/app/Activity;Lcom/paypal/android/sdk/payments/cf;III)V
    ...
    iget-object v2, p1, Lcom/paypal/android/sdk/payments/cf;->a:Ljava/lang/Integer;
    ...
    iget-object v3, p1, Lcom/paypal/android/sdk/payments/cf;->b:Ljava/lang/String;
    ...
    sget-object v0, Lcom/paypal/android/sdk/fs;->bd:Lcom/paypal/android/sdk/fs;
    ...
    sget-object v2, Lcom/paypal/android/sdk/bx;->e:Lcom/paypal/android/sdk/bx;
    ...
    sget-object v0, Lcom/paypal/android/sdk/fs;->bj:Lcom/paypal/android/sdk/fs;
    ...
    :cond_56
    sget-object v0, Lcom/paypal/android/sdk/fs;->bb:Lcom/paypal/android/sdk/fs;
...
.method static a(Landroid/widget/TextView;Ljava/lang/String;)V
    ...
    invoke-static {p1}, Lcom/paypal/android/sdk/bn;->c(Ljava/lang/String;)Z
    ...
    :cond_10
    invoke-static {p1}, Lcom/paypal/android/sdk/bn;->b(Ljava/lang/String;)Z

    move-result v0

    if-eqz v0, :cond_20

    sget-object v0, Lcom/paypal/android/sdk/fs;->ag:Lcom/paypal/android/sdk/fs;
    ...
    :cond_20
    invoke-static {p1}, Lcom/paypal/android/sdk/bn;->a(Ljava/lang/String;)Z

    move-result v0

    if-eqz v0, :cond_30

    sget-object v0, Lcom/paypal/android/sdk/fs;->af:Lcom/paypal/android/sdk/fs;
...
.method public b()Ljava/lang/String;
    ...
    invoke-static {v6}, Lcom/paypal/android/sdk/d;->b(Ljava/lang/CharSequence;)Z
...
.method public c()Ljava/lang/String;
    ...
    const-string v0, "8c4da320d7aae74624981ab9720ab1b9e72b9ce8"
