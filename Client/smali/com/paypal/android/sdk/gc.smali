...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/paypal/android/sdk/gc;->a:Landroid/widget/TableLayout;

    iget-object v0, p0, Lcom/paypal/android/sdk/gc;->a:Landroid/widget/TableLayout;
    ...
    iput-object v0, p0, Lcom/paypal/android/sdk/gc;->b:Landroid/widget/TableRow;

    iget-object v0, p0, Lcom/paypal/android/sdk/gc;->a:Landroid/widget/TableLayout;

    iget-object v1, p0, Lcom/paypal/android/sdk/gc;->b:Landroid/widget/TableRow;

    invoke-virtual {v0, v1}, Landroid/widget/TableLayout;->addView(Landroid/view/View;)V

    iget-object v0, p0, Lcom/paypal/android/sdk/gc;->b:Landroid/widget/TableRow;

    const-string v1, "30dip"

    invoke-static {v0, v6, v1}, Lcom/paypal/android/sdk/cv;->a(Landroid/view/View;ILjava/lang/String;)V
    ...
    invoke-static {v0, v7, v1}, Lcom/paypal/android/sdk/cv;->a(Landroid/view/View;IF)V

    new-instance v0, Landroid/widget/TableRow;

    invoke-direct {v0, p1}, Landroid/widget/TableRow;-><init>(Landroid/content/Context;)V

    iget-object v1, p0, Lcom/paypal/android/sdk/gc;->a:Landroid/widget/TableLayout;
    ...
    iput-object v1, p0, Lcom/paypal/android/sdk/gc;->c:Landroid/widget/TextView;

    iget-object v1, p0, Lcom/paypal/android/sdk/gc;->c:Landroid/widget/TextView;
    ...
    sget v2, Lcom/paypal/android/sdk/cu;->j:I
    ...
    iget-object v0, p0, Lcom/paypal/android/sdk/gc;->c:Landroid/widget/TextView;

    const/4 v1, -0x1

    invoke-static {v0, v6, v1}, Lcom/paypal/android/sdk/cv;->a(Landroid/view/View;II)V
    ...
    iput-object v1, p0, Lcom/paypal/android/sdk/gc;->d:Landroid/widget/TextView;

    iget-object v1, p0, Lcom/paypal/android/sdk/gc;->d:Landroid/widget/TextView;

    sget v2, Lcom/paypal/android/sdk/cu;->b:I
    ...
    iget-object v0, p0, Lcom/paypal/android/sdk/gc;->d:Landroid/widget/TextView;
