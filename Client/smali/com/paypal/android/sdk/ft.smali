...
.field public f:Lcom/paypal/android/sdk/fu;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/paypal/android/sdk/ft;->c:[Landroid/widget/TextView;

    invoke-static {p1}, Lcom/paypal/android/sdk/cv;->a(Landroid/content/Context;)Landroid/view/ViewGroup;

    move-result-object v0

    iput-object v0, p0, Lcom/paypal/android/sdk/ft;->j:Landroid/view/ViewGroup;

    iget-object v0, p0, Lcom/paypal/android/sdk/ft;->j:Landroid/view/ViewGroup;

    invoke-static {v0}, Lcom/paypal/android/sdk/cv;->a(Landroid/view/ViewGroup;)Landroid/widget/LinearLayout;

    move-result-object v0

    iput-object v0, p0, Lcom/paypal/android/sdk/ft;->k:Landroid/widget/LinearLayout;

    iget-object v0, p0, Lcom/paypal/android/sdk/ft;->k:Landroid/widget/LinearLayout;
    ...
    invoke-static {v0, v3, v4, v5, v6}, Lcom/paypal/android/sdk/cv;->a(Landroid/view/View;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-object v0, p0, Lcom/paypal/android/sdk/ft;->l:Landroid/widget/ImageView;

    iget-object v0, p0, Lcom/paypal/android/sdk/ft;->l:Landroid/widget/ImageView;
    ...
    invoke-static {v3, p1}, Lcom/paypal/android/sdk/cv;->c(Ljava/lang/String;Landroid/content/Context;)Landroid/graphics/Bitmap;
    ...
    invoke-static {v0, v9, v3}, Lcom/paypal/android/sdk/cv;->a(Landroid/view/View;ILjava/lang/String;)V

    iget-object v0, p0, Lcom/paypal/android/sdk/ft;->l:Landroid/widget/ImageView;

    const-string v3, "10dip"

    invoke-static {v0, v8, v8, v8, v3}, Lcom/paypal/android/sdk/cv;->b(Landroid/view/View;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v3, p0, Lcom/paypal/android/sdk/ft;->c:[Landroid/widget/TextView;

    new-instance v4, Landroid/widget/TextView;

    invoke-direct {v4, p1}, Landroid/widget/TextView;-><init>(Landroid/content/Context;)V

    sget v5, Lcom/paypal/android/sdk/cu;->k:I

    invoke-virtual {v4, v5}, Landroid/widget/TextView;->setTextColor(I)V

    sget-object v5, Lcom/paypal/android/sdk/cu;->t:Landroid/content/res/ColorStateList;

    invoke-virtual {v4, v5}, Landroid/widget/TextView;->setLinkTextColor(Landroid/content/res/ColorStateList;)V

    sget-object v5, Lcom/paypal/android/sdk/cu;->s:Landroid/graphics/Typeface;
    ...
    invoke-static {v4, v9, v7}, Lcom/paypal/android/sdk/cv;->a(Landroid/view/View;II)V

    const-string v5, "10dip"

    invoke-static {v4, v8, v5}, Lcom/paypal/android/sdk/cv;->a(Landroid/view/View;Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-object v0, p0, Lcom/paypal/android/sdk/ft;->d:Landroid/widget/TextView;

    iget-object v0, p0, Lcom/paypal/android/sdk/ft;->d:Landroid/widget/TextView;
    ...
    invoke-static {v0}, Lcom/paypal/android/sdk/cv;->b(Landroid/widget/TextView;)V
    ...
    invoke-static {v0, v9, v7}, Lcom/paypal/android/sdk/cv;->a(Landroid/view/View;II)V
    ...
    invoke-static {v0, v1, v3}, Lcom/paypal/android/sdk/cv;->a(Landroid/view/View;Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-object v0, p0, Lcom/paypal/android/sdk/ft;->e:Landroid/widget/TextView;

    iget-object v0, p0, Lcom/paypal/android/sdk/ft;->e:Landroid/widget/TextView;
    ...
    invoke-static {v0, v8, v1, v8, v3}, Lcom/paypal/android/sdk/cv;->b(Landroid/view/View;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {p1, v10, v10, v2}, Lcom/paypal/android/sdk/cv;->a(Landroid/content/Context;ZILandroid/widget/LinearLayout;)Landroid/widget/LinearLayout;

    move-result-object v0

    iput-object v0, p0, Lcom/paypal/android/sdk/ft;->h:Landroid/widget/LinearLayout;

    iget-object v0, p0, Lcom/paypal/android/sdk/ft;->h:Landroid/widget/LinearLayout;
    ...
    iput-object v0, p0, Lcom/paypal/android/sdk/ft;->i:Landroid/widget/TextView;

    iget-object v0, p0, Lcom/paypal/android/sdk/ft;->i:Landroid/widget/TextView;
    ...
    iget-object v1, p0, Lcom/paypal/android/sdk/ft;->i:Landroid/widget/TextView;
    ...
    iput-object v0, p0, Lcom/paypal/android/sdk/ft;->g:Landroid/widget/Button;

    iget-object v0, p0, Lcom/paypal/android/sdk/ft;->g:Landroid/widget/Button;
    ...
    invoke-static {v0}, Lcom/paypal/android/sdk/cv;->a(Landroid/widget/Button;)V
    ...
    invoke-static {v0, v8, v8, v8, v1}, Lcom/paypal/android/sdk/cv;->b(Landroid/view/View;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-object v0, p0, Lcom/paypal/android/sdk/ft;->f:Lcom/paypal/android/sdk/fu;

    iget-object v0, p0, Lcom/paypal/android/sdk/ft;->k:Landroid/widget/LinearLayout;

    iget-object v1, p0, Lcom/paypal/android/sdk/ft;->f:Lcom/paypal/android/sdk/fu;

    iget-object v1, v1, Lcom/paypal/android/sdk/fu;->a:Landroid/widget/LinearLayout;

    invoke-virtual {v0, v1}, Landroid/widget/LinearLayout;->addView(Landroid/view/View;)V

    iget-object v0, p0, Lcom/paypal/android/sdk/ft;->f:Lcom/paypal/android/sdk/fu;
