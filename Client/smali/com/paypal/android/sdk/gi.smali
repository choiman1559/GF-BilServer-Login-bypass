...
.method public constructor <init>(Landroid/content/Context;Ljava/util/ArrayList;I)V
    ...
    iput p3, p0, Lcom/paypal/android/sdk/gi;->a:I
...
.method private static a(Landroid/content/Context;Landroid/widget/RelativeLayout;Ljava/lang/String;I)I
    ...
    invoke-static {v3, v3, v1, v2}, Lcom/paypal/android/sdk/cv;->a(IIII)Landroid/widget/RelativeLayout$LayoutParams;
    ...
    invoke-static {v0, v2}, Lcom/paypal/android/sdk/cv;->d(Landroid/widget/TextView;I)V

    const-string v2, "6dip"

    const-string v3, "6dip"

    invoke-static {v0, v2, v4, v3, v4}, Lcom/paypal/android/sdk/cv;->b(Landroid/view/View;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method public final a(I)V
    ...
    iput p1, p0, Lcom/paypal/android/sdk/gi;->a:I
...
.method public final getView(ILandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    invoke-virtual {p0, p1}, Lcom/paypal/android/sdk/gi;->getItem(I)Ljava/lang/Object;
    ...
    invoke-static {v3, v4, v5, v6, v7}, Lcom/paypal/android/sdk/cv;->a(Landroid/view/View;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {p3}, Landroid/view/ViewGroup;->getContext()Landroid/content/Context;

    move-result-object v4

    invoke-virtual {v0}, Lcom/paypal/android/sdk/gh;->a()Ljava/lang/String;

    move-result-object v5

    const-string v6, ""

    invoke-static {v4, v5, v6}, Lcom/paypal/android/sdk/cv;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Landroid/widget/ImageView;
    ...
    invoke-static {v1, v5, v6, v7}, Lcom/paypal/android/sdk/cv;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;I)Landroid/widget/RelativeLayout$LayoutParams;
    ...
    invoke-static {v4, v5, v6, v7, v8}, Lcom/paypal/android/sdk/cv;->a(Landroid/view/View;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    sget v5, Lcom/paypal/android/sdk/cu;->b:I
    ...
    iget v5, p0, Lcom/paypal/android/sdk/gi;->a:I
    ...
    invoke-virtual {v0}, Lcom/paypal/android/sdk/gh;->f()Ljava/lang/String;
    ...
    invoke-static {v4, v5}, Lcom/paypal/android/sdk/cv;->b(Landroid/widget/TextView;I)V
    ...
    invoke-static {v4, v5, v6, v7, v8}, Lcom/paypal/android/sdk/cv;->b(Landroid/view/View;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v5, v6, v7, v8}, Lcom/paypal/android/sdk/cv;->a(IIII)Landroid/widget/RelativeLayout$LayoutParams;

    move-result-object v5

    invoke-virtual {v3, v4, v5}, Landroid/widget/RelativeLayout;->addView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V

    invoke-virtual {v0}, Lcom/paypal/android/sdk/gh;->g()Ljava/lang/String;

    move-result-object v4

    const/16 v5, 0x8ff

    invoke-static {v1, v3, v4, v5}, Lcom/paypal/android/sdk/gi;->a(Landroid/content/Context;Landroid/widget/RelativeLayout;Ljava/lang/String;I)I

    move-result v4

    invoke-virtual {v0}, Lcom/paypal/android/sdk/gh;->h()Ljava/lang/String;

    move-result-object v5

    invoke-static {v1, v3, v5, v4}, Lcom/paypal/android/sdk/gi;->a(Landroid/content/Context;Landroid/widget/RelativeLayout;Ljava/lang/String;I)I
    ...
    invoke-virtual {v0}, Lcom/paypal/android/sdk/gh;->i()Ljava/lang/String;
    ...
    invoke-virtual {v0}, Lcom/paypal/android/sdk/gh;->j()Ljava/lang/String;

    move-result-object v6

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v0}, Lcom/paypal/android/sdk/gh;->k()Ljava/lang/String;
    ...
    :cond_f4
    invoke-virtual {v0}, Lcom/paypal/android/sdk/gh;->l()Ljava/lang/String;
    ...
    invoke-static {v1, v3, v0, v4}, Lcom/paypal/android/sdk/gi;->a(Landroid/content/Context;Landroid/widget/RelativeLayout;Ljava/lang/String;I)I
