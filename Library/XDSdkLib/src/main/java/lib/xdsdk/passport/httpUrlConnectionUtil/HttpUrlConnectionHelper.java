...
public class HttpUrlConnectionHelper {
    ...
    public static String setPost(Activity activity, String str) throws Exception {
    ...
    public static void doPost(final Activity activity, final String str, final HttpCallbackModelListener<Object> httpCallbackModelListener, Map<String, Object> map) throws Exception {
        String str3;
